...
project = "APRSD Prometheus Exporter"
copyright = ""
...
release = Distribution.from_name("aprsd-exporter").version
...
# Suppress duplicate label warnings for included files
# The root-level RST files (AUTHORS.rst, CONTRIBUTING.rst, HISTORY.rst)
# are included in wrapper files, causing duplicate labels that don't affect functionality
